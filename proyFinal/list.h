...
struct list_head {
    struct list_head *entry, *next, *prev;
};
...
/**
 * list_pop - deletes the first entry from list and returns it
...
/**
 * list_pop_tail - deletes the last entry from list and returns it
 * @head: list head to delete from
 */
...
/**
 * list_pop_entry - deletes the first entry and returns the struct for it
 * @head:   the head for your list.
 * @type:   the type of the struct this is embedded in.
 * @member: the name of the list_head within the struct.
 */
#define list_pop_entry(head, type, member)                      \
    ({                                                          \
        struct list_head *first = list_pop(head);               \
        first == NULL ? NULL : list_entry(first, type, member); \
    })

/**
 * list_pop_tail_entry - deletes the last entry and returns the struct for it
 * @head:   the head for your list.
 * @type:   the type of the struct this is embedded in.
 * @member: the name of the list_head within the struct.
 */
#define list_pop_tail_entry(head, type, member)                 \
    ({                                                          \
        struct list_head *first = list_pop_tail(head);          \
        first == NULL ? NULL : list_entry(first, type, member); \
    })
