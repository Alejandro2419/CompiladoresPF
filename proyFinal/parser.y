...
%type<tipo> tipo tipo_reg lista arreglo
...
sentencia       : IF condicion {
                    ...
                    u16 inst = code_push(code_list, "label", "", "", "__");
                    dir_push($2.false, inst);
                } sentencia {
                    code_backpatch(code_list, $2.true, etiqueta_crear());
                    code_backpatch(code_list, $2.false, etiqueta_crear());
                    dir_push($8.next, code_push(code_list, "label", "", "", "__"));
                    $$.next = combinar($8.next, combinar($4.next, $<sent>5.next));
                ...
                sentencia {
                    ...
                    $6.next = combinar($6.next, $<sent>2.next);
                    code_backpatch(code_list, $6.next, et);
                ...
                | DO {
                    ...
                    $6.true = combinar($<sent>2.next, $6.true);
                    code_backpatch(code_list, $6.true, etiqueta_crear());
                ...
                | SWITCH PI expresion PD DO casos predeterminado LD {}
                | BREAK PYC {
                    $$.next = list_new();
